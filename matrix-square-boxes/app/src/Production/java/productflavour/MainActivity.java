...
import productflavour.model.User;
import productflavour.viewmodel.IUpdateInterface;
import productflavour.viewmodel.RecyclerAdapter;
import productflavour.viewmodel.UserAdapter;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, IUpdateInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //list of static color codes for 4x4 matrix
        ...
        colorCode.add("#76ff03");
        colorCode.add("#76ff03");
        colorCode.add("#ffea00");
        colorCode.add("#ffea00");
        colorCode.add("#ffea00");
        colorCode.add("#ffea00");

        adapter = new RecyclerAdapter(this, colorCode);
    ...
    private void getData() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                userAdapter = new UserAdapter(context, name, score, String.valueOf(sec));
    ...
    private void getScramble() {
        ...
        adapter = new RecyclerAdapter(this, scrambledColorCode, MainActivity.this);
        recyclerView.setAdapter(adapter);
        timer();
